...
public class MoveingPlaneTest : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        rotation.eulerAngles = Input.gyro.rotationRate + zeroPoint;
    ...
    void ResetCursor()
    {
        zeroPoint = new Vector3(Input.gyro.rotationRate.x, Input.gyro.rotationRate.y, Input.gyro.rotationRate.z);
    }
